...
process.load('RecoLocalTracker.SiStripRecHitConverter.ApproxSiStripRecHitConverter_cfi')
process.ApproximateRecHits = process.approxSiStripMatchedRecHits.clone(
     ClusterProducer = 'SiStripClusters2ApproxClusters' 
)
...
MassReplaceInputTag(process, new="SiStripClusters2ApproxClusters", old="siStripClusters")
