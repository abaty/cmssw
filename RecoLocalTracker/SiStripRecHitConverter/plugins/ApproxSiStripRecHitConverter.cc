...
ApproxSiStripRecHitConverter::ApproxSiStripRecHitConverter(edm::ParameterSet const& conf)
  ...
  clusterProducer =
      consumes<edmNew::DetSetVector<SiStripApproximateCluster> >(conf.getParameter<edm::InputTag>("ClusterProducer"));
...
void ApproxSiStripRecHitConverter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  ApproxSiStripRecHitConverterAlgorithm::fillPSetDescription(desc);
...
void ApproxSiStripRecHitConverter::produce(edm::Event& e, const edm::EventSetup& es) {
  edm::Handle<edmNew::DetSetVector<SiStripApproximateCluster> > clusters;

  ApproxSiStripRecHitConverterAlgorithm::products output;
  ...
  LogDebug("ApproxSiStripRecHitConverter") << "found\n"
