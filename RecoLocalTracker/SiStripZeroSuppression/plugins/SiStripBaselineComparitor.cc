...
class SiStripBaselineComparitor : public edm::EDAnalyzer {
   public:
      explicit SiStripBaselineComparitor(const edm::ParameterSet&);
      ~SiStripBaselineComparitor();
...
SiStripBaselineComparitor::SiStripBaselineComparitor(const edm::ParameterSet& conf){
...
SiStripBaselineComparitor::~SiStripBaselineComparitor()
{
}

void
SiStripBaselineComparitor::analyze(const edm::Event& e, const edm::EventSetup& es)
{
...
void SiStripBaselineComparitor::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
SiStripBaselineComparitor::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(SiStripBaselineComparitor);
