...
process.TFileService = cms.Service("TFileService",
        fileName=cms.string("Baselines_IteratedMedian.root"))
...
process.moddedZS.Algorithms.CommonModeNoiseSubtractionMode = cms.string("Median")
process.moddedZS.Algorithms.DeltaCMThreshold = 5
#process.moddedZS.Algorithms.CommonModeNoiseSubtractionMode = cms.string("Percentile")
#process.moddedZS.Algorithms.Percentile = cms.double(75)
#process.moddedZS.Algorithms.ForceNoRestore = True
#process.moddedZS.Algorithms.PedestalSubtractionFedMode = cms.bool(True)
